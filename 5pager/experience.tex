...
\begin{cventries}
\cventry
    {Solutions Architect (Digital Humanities)} % Job title
    ...
    \cventry
    {Technical Director, Field Acquired Information Management Systems (FAIMS) Project} % Job title
    {Macquarie University} % Organization
    {2015 -- 2018} % Date(s)
    {Sydney, Australia} % Location
    {\begin{cvitems}%
...
\cventry
    {Data Architect, Federated Archaeological Information Management Systems (FAIMS) Project} % Job title
